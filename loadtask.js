...
const CERT_DIR = path.join(__dirname, 'ano-cert');
const CERT = path.join(CERT_DIR, '84359b70c4a325508a8567a567db36d65f7698987924fbe17e586a40e44a7420-certificate.pem.crt');
const KEY = path.join(CERT_DIR, '84359b70c4a325508a8567a567db36d65f7698987924fbe17e586a40e44a7420-private.pem.key');
const CA = path.join(CERT_DIR, 'AmazonRootCA1.pem');

const TOPIC = 'fleet/telemetry';
const VEHICLE_COUNT = 1000; // start with 500 vehicles
